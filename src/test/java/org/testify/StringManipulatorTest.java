...
public class StringManipulatorTest {
    ...
    public void testConcatenate() {
        ...
        assertThrows(IllegalArgumentException.class, () -> manipulator.concatenate(null, "world"));
    }

    @Test
    public void testToUpperCase() {
        assertEquals("HELLO", manipulator.toUpperCase("hello"));
        assertThrows(IllegalArgumentException.class, () -> manipulator.toUpperCase(null));
    }

    @Test
    public void testStringLength() {
        assertEquals(5, manipulator.stringLength("hello"));
        assertThrows(IllegalArgumentException.class, () -> manipulator.stringLength(null));
    }
    ...
    public void testLongestSubstringWithoutRepeatingCharacters() {
        ...
        assertThrows(IllegalArgumentException.class, () -> manipulator.longestSubstringWithoutRepeatingCharacters(null));
    }
    ...
    public void testCountSubstringOccurrences() {
        ...
        assertThrows(IllegalArgumentException.class, () -> manipulator.countSubstringOccurrences(null, "test"));
    }
}
